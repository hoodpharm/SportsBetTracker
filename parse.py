...
def parse_args(): 
    ...
    parser.add_argument("-w", "--wager", metavar='', help="bet amount", type=float)
    parser.add_argument("-O", "--outcome", metavar='', help="W/L?")
    parser.add_argument("-v", help="verbose", action="store_true")
    parser.add_argument("-d", "--date", metavar='', help="change date of bet, default is todays date. ('YYYY-MM-DD')")
    ...
    parser.add_argument("--max_win", help="show max win", action="store_true")
    parser.add_argument("--max_loss", help="show max loss", action="store_true")
